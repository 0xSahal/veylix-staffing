...
export const solutions: Record<string, SolutionPageData> = {
  ...
  payrolling: {
    slug: 'payrolling',
    path: routes.payrolling,
    title: 'Payrolling Services',
    tagline: 'We handle the payroll — you keep the talent',
    introHeading: 'Simplify Employment Overhead',
    introBody:
      "Our payrolling service lets you bring on talent you've already identified while we handle all payroll administration, tax withholding, benefits, and compliance. It's the perfect solution when you want to manage the worker relationship but not the employment overhead.",
    imageSeed: 'payroll',
    roleCards: [
      {
        title: 'Payroll Processing',
        roles: ['Weekly/Bi-Weekly payroll', 'Direct deposit', 'W-2/1099 management'],
      },
      {
  ...
  training: {
    ...
    tagline: 'Empower your team with the skills to succeed',
    introHeading: 'Upskill Your Workforce',
    introBody:
      'Our training programs are designed to upskill your workforce, close skill gaps, and prepare teams for emerging technologies. Whether onboarding new hires or developing existing staff, we deliver programs tailored to your industry and goals.',
    imageSeed: 'training',
    roleCards: [
      {
