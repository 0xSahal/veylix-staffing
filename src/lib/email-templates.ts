...
export function contactEmailTemplates(data: ContactFormData): {
  ...
  const userHtml = emailLayout(`
    ...
    <p style="margin:0 0 16px;">Email: <a href="mailto:info@veylixstaffing.com" style="color:${BRAND.blue};">info@veylixstaffing.com</a></p>
...
export function jobOrderEmailTemplates(
  ...
  const userHtml = emailLayout(`
    ...
    <p style="margin:0 0 16px;">If your hiring need is urgent, email us at <a href="mailto:info@veylixstaffing.com" style="color:${BRAND.blue};">info@veylixstaffing.com</a> and reference your order number.</p>
